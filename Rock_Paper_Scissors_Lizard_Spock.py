...
while True:
    ...
    keep = input("Do you wish to play one more game?  (yes/no): ").lower()
    if keep != "yes":
        break
print("Thank you for playing William's Rock Paper Scissors Lizard Spock. Hope to see you soon. Good Bye! ")
